    ...
    <header className="sticky top-0 z-50 bg-[var(--color-bg)]/90 backdrop-blur border-b border-[var(--color-border)]">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-5 py-4">
        <NavLink to="/" className="flex items-center gap-3" onClick={closeMenu}>
          <div className="badge-brute size-10 flex items-center justify-center font-bold text-black bg-[var(--color-primary)]">
            {coach.initials}
          </div>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="btn-brute hidden lg:inline-block text-sm font-bold uppercase tracking-wide px-5 py-2.5 bg-[var(--color-primary)] text-black hover:bg-[var(--color-accent)] transition-colors"
        >
          Nous écrire
        </a>
        ...
        <ul className="min-h-0 overflow-hidden flex flex-col gap-1 px-5 border-t border-[var(--color-border)] pt-4">
          ...
          <li>
            <a
              ...
              rel="noreferrer"
              onClick={closeMenu}
              className="btn-brute inline-block mt-2 px-5 py-2 font-bold uppercase tracking-wide bg-[var(--color-primary)] text-black"
            >
              Nous écrire
            </a>
          </li>
